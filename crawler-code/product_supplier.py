...
log_stream_name = 'product_supplier'
...
crawler_name = 'product_supplier'
role_name = 'arn:aws:iam::352196831952:role/ti-p-role-etl-instructor'
database_name = 'glue_db'
s3_input_path = 's3://ti-p-data/retail/product_supplier/'
s3_output_path = 's3://ti-p-data/retail/product_supplier/'
