...
log_stream_name = 'electric_vechiles'
...
crawler_name = 'electric_vechiles'
role_name = 'arn:aws:iam::352196831952:role/ti-p-role-etl-instructor'
database_name = 'glue_db'
s3_input_path = 's3://ti-p-data/electric-vehicles/electric_vechiles/'
s3_output_path = 's3://ti-p-data/electric-vehicles/electric_vechiles/'
